...
setup(
    ...
    url='https://github.com/andreimircescu/aws-iot-segmentation/archive/0.4.tar.gz',
    download_url='https://github.com/andreimircescu/aws-iot-segmentation/archive/0.4.tar.gz',
